...
<head>
	...
	<title>Ingreso - Pancho Villa</title>
	...
	<div class="formWrapper">
		<form id="loginForm">
			...
			<div class="inputblock">
				...
				<input id="email" name="email" type="email" autocomplete="email" required placeholder="Ingresa tu email" onkeydown="if(event.key === 'Enter'){event.preventDefault();login();}"/>
			</div>
			<div class="inputblock">
				<label for="password">Password</label>
				<input id="password" name="password" type="password" autocomplete="current-password" required placeholder="Ingresa tu password" onkeydown="if(event.key === 'Enter'){event.preventDefault();login();}"/>
			</div>
			<br>
			<div class="btn" onclick="login();">Ingresar</div>
			<br>
			<br>
			<br>
			<a href="./register">¿No tienes una cuenta? Registrarse</a>
			<br>
			<a href="./resetpassword">¿Perdiste tu password? Resetear</a>
		</form>
