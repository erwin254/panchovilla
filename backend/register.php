...
<head>
	...
	<title>Register - Pancho Villa</title>
	...
	<div class="formWrapper">
		<form id="registerForm">
			...
			<div class="inputblock">
				...
				<input id="name" name="name" type="text" autocomplete="name" placeholder="Ingresa tu nombre" onkeydown="if(event.key === 'Enter'){event.preventDefault();register();}" />
			</div>
			<div class="inputblock">
				<label for="email">Email</label>
				<input id="email" name="email" type="email" autocomplete="email" placeholder="Ingresa tu email" onkeydown="if(event.key === 'Enter'){event.preventDefault();register();}" />
			</div>
			<div class="inputblock">
				<label for="password">Password</label>
				<input id="password" name="password" type="password" autocomplete="new-password" placeholder="Ingresa tu password" onkeydown="if(event.key === 'Enter'){event.preventDefault();register();}" />
			</div>
			<div class="inputblock">
				<label for="confirm-password">Confirmar Password</label>
				<input id="confirm-password" name="confirm-password" type="password" autocomplete="new-password" placeholder="Confirma tu password" onkeydown="if(event.key === 'Enter'){event.preventDefault();register();}" />
			</div>
			<br>
			<div class="btn" onclick="register();">Registrar</div>
			<br>
			<br>
			<br>
